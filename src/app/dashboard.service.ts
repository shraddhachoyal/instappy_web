...
export class DashboardService {
  ...
  updateAppName(appName: AppName) {
    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) };
    return this.httpClient.post<AppName[]>(api_url + 'apps-details/app-details-update/', appName, httpOptions)
  }
  ...
  getAdditionalAppInfo(app_type: number, auth_id: number) {
    //http://52.10.50.94/api/apps-details/additional-app-details-list/160/3
